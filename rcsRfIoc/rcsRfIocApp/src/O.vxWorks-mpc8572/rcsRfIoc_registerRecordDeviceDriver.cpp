...
epicsShareExtern dset *pvar_dset_devAiD212;
...
epicsShareExtern dset *pvar_dset_devBoD212;
...
epicsShareExtern dset *pvar_dset_devWfWrD212;
...
{
    const char *bldTop = "/home/RCS/EpicsBak/rcsRfIoc";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"rcsRfIoc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
